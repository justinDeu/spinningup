...
def td3(env_fn, actor_critic=core.MLPActorCritic, ac_kwargs=dict(), seed=0, 
    ...
    def compute_loss_q(data):
        ...
        epsilon_clamped = torch.clamp(epsilon, -noise_clip, noise_clip)

        a_prime = torch.clamp(pi_targ + epsilon_clamped, -act_limit, act_limit)

        # Target Q-values
        q1_pi_targ = ac_targ.q1(o2, a_prime)
        q2_pi_targ = ac_targ.q2(o2, a_prime)
